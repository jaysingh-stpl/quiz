...
<?php echo $this->lang->line('hello'); ?> <?php echo $result['first_name']; ?>
            ...
            <div class="col-lg-12" style="margin-top:20px;">
                ...
                <div class="col-lg-2" style="text-align:center;">
                    ...
                    <p style="color:#e39500;"><?php echo substr(((($percentile[1] + 1) / $percentile[0]) * 100), 0, 5); ?>
                        %</p>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th style="background:#337ab7;color:#ffffff;"><?php echo secintomin($result['total_time']); ?>
                            Min. <?php echo $this->lang->line('approx'); ?></th>
            ...
            <div class="col-lg-12 noprint" style="margin-top:50px;">
                <button class="btn btn-default"
                        style="margin-right:20px;width:141px;	float:left;"> <?php echo $this->lang->line('rank') . ': ' . $rank; ?> </button>
                <div class="td_line" style="float:left;width:700px;height:70px;">
                    <div <?php if ($rank == '1'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Rank"
                         <?php }else{ ?>class="circle_result"<?php } ?>>1
                    </div>
                    <div <?php if ($rank == '2'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Rank"
                         <?php }else{ ?>class="circle_result"<?php } ?>>2
                    </div>
                    <div <?php if ($rank == '3'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Rank"
                         <?php }else{ ?>class="circle_result"<?php } ?>>3
                    </div>
                    <?php
                    if ($rank > 3) {
                        ?>
                        <div class="circle_ur s_title" data-toggle="tooltip" title="Your Rank"
                             style="margin-left:<?php echo intval(($rank / $last_rank) * 100); ?>%"><?php echo $rank; ?></div>
                        <?php
                    }
                    ?>
                    ...
                    if ($rank != $last_rank) {
                        ?>
                        <div class="circle_l s_title" data-toggle="tooltip"
                             title="Last Rank"><?php echo $last_rank; ?></div>
                        <?php
                    } else {
                        ?>
                        <div class="circle_l s_title" data-toggle="tooltip"
                             title="Your Rank is Last"><?php echo $last_rank; ?></div>
            ...
            <div class="col-lg-12 noprint" style="margin-top:50px;">
                <button class="btn btn-default"
                        style="margin-right:20px;width:141px;	float:left;"> <?php echo $this->lang->line('score_obtained') . ': ' . $result['score_obtained']; ?> </button>
                <div class="td_line" style="float:left;width:700px;height:70px;">
                    <div <?php if ($rank == '1'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                         <?php }else{ ?>class="circle_result"<?php } ?>><?php echo $toppers[0]['score_obtained']; ?></div>
                    <div <?php if ($rank == '2'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                         <?php }else{ ?>class="circle_result"<?php } ?>><?php echo $toppers[1]['score_obtained']; ?></div>
                    <div <?php if ($rank == '3'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                         <?php }else{ ?>class="circle_result"<?php } ?>><?php echo $toppers[2]['score_obtained']; ?></div>
                    <?php
                    if ($rank > 3) {
                        ?>
                        <div class="circle_ur s_title" data-toggle="tooltip" title="Your Score"
                             style="margin-left:<?php echo intval(($rank / $last_rank) * 100); ?>%"><?php echo $result['score_obtained']; ?></div>
                        <?php
                    }
                    ?>
                    ...
                    if ($rank != $last_rank) {
                        ?>
                        <div class="circle_l s_title" data-toggle="tooltip"
                             title="Lowest Score"><?php echo $looser['score_obtained']; ?></div>
                        <?php
                    } else {
                        ?>
                        <div class="circle_l s_title" data-toggle="tooltip"
                             title="Lowest Score is Your"><?php echo $looser['score_obtained']; ?></div>
            ...
            <div class="col-lg-12 noprint" style="margin-top:50px;margin-bottom:50px;">
                <button class="btn btn-default"
                        style="margin-right:20px;width:141px;	float:left;"> <?php echo $this->lang->line('time') . ': ' . secintomin($result['total_time']) . ' Min.'; ?>   </button>
                <div class="td_line" style="float:left;width:700px;height:70px;">
                    <div <?php if ($rank == '1'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                         <?php }else{ ?>class="circle_result"<?php } ?>
                         style="font-size:12px;padding-top:10px;"><?php echo secintomin($toppers[0]['total_time']); ?></div>
                    <div <?php if ($rank == '2'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                         <?php }else{ ?>class="circle_result"<?php } ?>
                         style="font-size:12px;padding-top:10px;"><?php echo secintomin($toppers[1]['total_time']); ?></div>
                    <div <?php if ($rank == '3'){ ?>class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                         <?php }else{ ?>class="circle_result"<?php } ?>
                         style="font-size:12px;padding-top:10px;"><?php echo secintomin($toppers[2]['total_time']); ?></div>
                    <?php
                    if ($rank > 3) {
                        ?>
                        <div class="circle_ur s_title" data-toggle="tooltip" title="Your Time"
                             style="margin-left:<?php echo intval(($rank / $last_rank) * 100); ?>%"
                             style="font-size:12px;padding-top:10px;"><?php echo secintomin($result['total_time']); ?></div>
                        <?php
                    }
                    ?>
                    ...
                    if ($rank != $last_rank) {
                        ?>
                        <div class="circle_l s_title" data-toggle="tooltip" title="Last Ranker's Time"
                             style="font-size:12px;padding-top:10px;"><?php echo secintomin($looser['total_time']); ?></div>
                        <?php
                    } else {
                        ?>
                        <div class="circle_l s_title" data-toggle="tooltip" title="Last Ranker's Time"
                        ...
                        <div class="panel-body">
                            ...
                            foreach ($questions as $qk => $question) {
                                ...
                                <div class="col-md-12 " id="q<?php echo $qk; ?>" class=""
                                     style="margin:10px;padding:10px;<?php if ($ind_score[$qk] == '1') { ?>background-color:#71ba5d; color:#ffffff;<?php } else if ($ind_score[$qk] == '2') { ?>background-color:#ff5e5e; color:#ffffff;<?php } else if ($ind_score[$qk] == '3') { ?>background-color:#fdfbcf;<?php } else { ?>background-color:#ffffff;<?php } ?>">
		...
		margin-top:6px;padding:14px;"><b><?php echo $qk + 1; ?></b></div>
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        ...
                                        if ($question['question_type'] == $this->lang->line('multiple_choice_single_answer')) {
                                            ...
                                            ?>
                                            <input type="hidden" name="question_type[]" id="q_type<?php echo $qk; ?>"
                                                   value="1">
                                            <?php
                                            $i = 0;
                                    ...
                                    <div class="col-md-2 col-sm-2" id="q<?php echo $qk; ?>" style="font-size:30px;">
                                        ...
                                        <?php if ($ind_score[$qk] == '1') { ?><i
                                                class="glyphicon glyphicon-ok"></i>  <?php } else if ($ind_score[$qk] == '2') { ?>
