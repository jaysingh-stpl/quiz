...
<!--<div class="alert alert-danger"><b>Like  Quiz?</b> <br>
Please <a href="#">buy installation service</a> which is like donating to this app and help  us to keep this app free & open source.

<a href="https://GST quiz.com/docs/edit_dashboard.php" target="docs" style="float:right;font-size:12px;color:#666666;">Remove it</a>
</div>-->
<div class="row">

<div class="col-md-4 nopadlft">
          ...
          <div class="table-responsive">
            <table class="table table-striped valign-middle">
              <thead>
                ...
                <th class="text-xs-right"><?php echo $this->lang->line('account_status');?></th>
...
<?php 
//echo "Page rendered in <strong>{elapsed_time}</strong> seconds. You may improve it by hosting on recommended hosting. <a href='http://GST quiz.com/affiliate.php' target='af'>Click here</a> ";
?>
</div>
