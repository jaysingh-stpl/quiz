...
<div class="col-md-4">
	...
	<div class="login-panel panel panel-default">
		...
		<div class="col-md-12 text-center"> <img src="<?php echo base_url('images/nacin_logo.png');?>"></div>
		

			<form method="post" class="form-signin col-md-12 " action="<?php echo site_url('login/forgot');?>">
