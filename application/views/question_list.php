...
<br> 
		...
		?>	
				...
				<div class="col-md-3 nopadlft">	<select   name="cid" class="form-control">
					...
					?>
                        ...
                        <div class="col-md-3 nopadlft"><select  name="lid" class="form-control">
...
?>
<tr>
 <td>  <a href="javascript:show_question_stat('<?php echo $val['qid'];?>');">+</a>  <?php echo $srno;$srno++; //$val['qid'];?></td>
...
<?php echo form_open('qbank/import',array('enctype'=>'multipart/form-data')); ?>
        ...
        <div class="col-md-3 nopadlft"><select name="cid"  required class="form-control">
...
?></select></div>
        <div class="col-md-3 nopadlft"><select name="did"  required class="form-control">
...
<?php 
        ...
        <div class="col-md-6 nopadlft">

	<input type="hidden" name="size" value="3500000">
	<input type="file" name="xlsfile" style="float:left;" class="form-control">
            <div class="right text-right uploadFileHelp"><?php echo $this->lang->line('upload_excel');?></div>
...
<?php
					...
					?></select></div>
            <div class="col-md-3 nopadlft"><select name="lid" required class="form-control">
 <option value=""><?php echo $this->lang->line('select_level');?></option>
<?php 
					foreach($level_list as $key => $val){
						?>
...
<div class="col-md-6 nopadlft">
	...
	<input type="hidden" name="size" value="3500000">
	<input type="file" name="word_file" style="float:left;" class="form-control">
    <div class="right text-right uploadFileHelp"><?php echo $this->lang->line('upload_doc');?></div>
</div>
	<div style="clear:both;"></div>
	<p style="padding:10px 0 0;"><a href="javascript:advanceconfig();" class="btn btn-info">Advance</a></p>
	<div id="advanceconfig" style="display:none">
	<table class="table table-responsive">
	<tr><td>Question Splitter:</td><td> <input type="text" class="form-control" name="question_split" value="/Q:[0-9]+\)/"></td></tr>
	<tr><td>Description Splitter: </td><td><input type="text" class="form-control" name="description_split" value="/Desc:/"></td></tr>
	<tr><td>Options Splitter: </td><td><input type="text" class="form-control" name="option_split" value="/[A-Z]:\)/"></td></tr>
	<tr><td>Correct Option Splitter: </td><td><input type="text" class="form-control" name="correct_split" value="/Correct:/"></td></tr>
	</table>
	</div>
