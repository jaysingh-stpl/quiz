...
if($logged_in['su']=='1'){
  ...
  <div class="col-lg-12">
    ...
    <h3><?php echo $this->lang->line('generate_report');?> </h3> 
       <div class="col-md-3 nopadlft"><select name="quid" class="form-control">
        ...
        <div class="col-md-3 nopadlft"><select name="gid" class="form-control">
...
?>
        ...
        <div class="col-md-2 nopadlft"><input type="text" name="date1" class="form-control" value="" placeholder="<?php echo $this->lang->line('date_from');?>"></div>

        <div class="col-md-2 nopadlft"><input type="text" name="date2" class="form-control" value="" placeholder="<?php echo $this->lang->line('date_to');?>"></div>
