    ...
    <div class="row" style="margin-top:5px;">
                                ...
                                foreach ($options as $ok => $option) {
                                    if ($option['qid'] == $question['qid']) {
                                        ...
                                        <div class="op op_style"
                                             onClick="checkrad('answer_value<?php echo $qk . '-' . $i; ?>');">
                                            <table>
                                                <tr>
                                                    <td><input type="radio" name="answer[<?php echo $qk; ?>][]"
                                                               id="answer_value<?php echo $qk . '-' . $i; ?>"
                                                               value="<?php echo $option['oid']; ?>" <?php if (in_array($option['oid'], $save_ans)) {
                                                            echo 'checked';
                                                        } ?> style="position:relative;"></td>
                                                    <td> <?php echo $option['q_option']; ?></td>
                                                </tr>
                                            </table>
                                        </div>
                            ...
                            if ($question['question_type'] == $this->lang->line('multiple_choice_multiple_answer')) {
                                ...
                                foreach ($options as $ok => $option) {
                                    if ($option['qid'] == $question['qid']) {
                                        ...
                                        <div class="op op_style">
                                            <div class="checkbox_layer"
                                                 onClick="checkrad2('answer_value<?php echo $qk . '-' . $i; ?>');"></div>


                                            <table>
                                                <tr>
                                                    <td><input type="checkbox" name="answer[<?php echo $qk; ?>][]"
                                                               id="answer_value<?php echo $qk . '-' . $i; ?>"
                                                               value="<?php echo $option['oid']; ?>" <?php if (in_array($option['oid'], $save_ans)) {
                                                            echo 'checked';
                                                        } ?> style="position:relative;"></td>
        ...
        <div class="col-md-4" style="padding-bottom:80px;">
            <div class="rightpanel"
                 style="display:none;z-index:1600; margin:0px;position:absolute;background:#ffffff;right:0px;padding:5px;border:1px solid #eeeeee;">
                ...
                <?php if (count($categories) > 1) {
                    ...
                    foreach ($categories as $cat_key => $category) {
                        ...
                        <a href="javascript:switch_category('cat_<?php echo $cat_key; ?>');"
                           ...
                           style="cursor:pointer;color:#666666;"><?php echo $category; ?></a>
                    ...
                    <table>
                        <tr>
                            <td style="font-size:10px;">
                                <div class="qbtn" style="background:#449d44;width:20px;height:20px;">&nbsp;
                                </div> <?php echo $this->lang->line('Answered'); ?>  </td>
                        </tr>
                        <tr>
                            <td style="font-size:10px;">
                                <div class="qbtn" style="background:#c9302c;width:20px;height:20px;">&nbsp;
                                </div> <?php echo $this->lang->line('UnAnswered'); ?>  </td>
                        </tr>
                        <tr>
                            <td style="font-size:10px;">
                                <div class="qbtn" style="background:#ec971f;width:20px;height:20px;">&nbsp;
                                </div> <?php echo $this->lang->line('Review-Later'); ?>  </td>
                        </tr>
                        <tr>
                            <td style="font-size:10px;">
                                <div class="qbtn" style="background:#212121;width:20px;height:20px;">&nbsp;
                                </div> <?php echo $this->lang->line('Not-visited'); ?>  </td>
                        </tr>
                    </table>
...
<div class="footer_buttons">
    <button class="btn btn-warning" onClick="javascript:review_later();"
            style="margin-top:2px;"><?php echo $this->lang->line('rl'); ?></button>
...
<div style="position:fixed;top:40%;width:80px;cursor:pointer; color:#8A6D3B;height:30px;right:0px;z-index:1200;background:#FCF8E3;padding:5px;border:1px solid #FAEBCC;vertical-align:center"
     id="slideri"><span class="glyphicons glyphicons-expand"></span> <?php echo $this->lang->line('pallet'); ?></div>
...
<div id="warning_div"
     style="padding:10px; position:fixed;z-index:1400;display:none;width:100%;border-radius:5px;height:200px; border:1px solid #dddddd;left:4px;top:70px;background:#ffffff;">
