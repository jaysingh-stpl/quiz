        ...
        <div class="col-sm-2">
            <a href="/users" class="pull-right">
                <img title="profile image" class="img-circle img-responsive"
                     src="http://www.gravatar.com/avatar/<?php echo md5($result['email']); ?>?s=100">
            </a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-3"><!--left col-->
            ...
            <ul class="list-group profile-group">
                ...
                <li class="list-group-item text-right"><span
                            class="pull-left"><strong><?php echo $this->lang->line('group_name'); ?></strong></span> <?php echo $result['group_name']; ?>
                </li>
                <li class="list-group-item text-right"><span
                            class="pull-left"><strong><?php echo $this->lang->line('account_type'); ?></strong></span> <?php if ($result['su'] == 1) {
            ...
            <ul class="list-group profile-group">
                ...
                <li class="list-group-item text-right"><span
                            class="pull-left"><strong><?php echo $this->lang->line('pass'); ?></strong></span> <?php echo $pass; ?>
                </li>
                <li class="list-group-item text-right"><span
                            class="pull-left"><strong><?php echo $this->lang->line('fail'); ?></strong></span> <?php echo $fail; ?>
                </li>
                <li class="list-group-item text-right"><span
                    ...
                    foreach ($categories as $k => $val) {
                        ...
                        <tr <?php if (intval($val) <= 50){ ?>style="background-color:#f2dede;"
                            ...
                            <td>
                                ...
                                ?>
                                <?php if ($category_recent[$k] >= 100) {
                                    echo '100';
                                } else {
                                    echo intval($category_recent[$k]);
                                } ?>%
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <p><?php echo $this->lang->line('percent_corrected'); ?>:
                        <?php if ($qv['no_time_served'] != '0') {
                            $perc = ($qv['no_time_corrected'] / $qv['no_time_served']) * 100;
                            ?>
