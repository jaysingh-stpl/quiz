	 ...
	 function config_sq(){
		...
		?>";
		 ...
		 // run sql file
			...
			$query=file_get_contents("GSTquiz_v4_0.sql");
		...
		if(chmod("./xls/",0777)){ } 
		if(chmod("./photo/",0777)){ }  
		rename("./application/controllers/Install.php","./application/controllers/Install.php");
		
		 /*
		$sq_base_url='http://localhost/GSTquiz_v3.0/';
