<?php 
$lang['gst_quiz'] = "GST Quiz";
$lang['installation_process'] = "Installation Process";
$lang['installation_completed'] = "Installation Completed. Visit base URL {base_url} to login.<br><br>Default login info:<br> Email: admin@example.com <br>Password: admin<br><br>For more information or customization visit <a href='#'>www.GSTQuiz.com/</a> ";
...
$lang['commercial_msg'] = "You are using free version of GST Quiz. <a href='#' target='sq'>Upgrade</a> to commercial version to get more features. ";
$lang['files_missing'] = "File doesn't exist";
$lang['files_missing2'] = "File doesn't exist or only available in commercial version. <br> For more please visit <a href='#' target='sq'>www.Quiz.com</a>";
