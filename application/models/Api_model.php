...
$uid=$user['uid'];
 $query=$this->db->query("select * from GST_result where uid='$uid' group by quid");
return $query->num_rows();						
...
$uid=$user['uid'];
 $query=$this->db->query("select * from GST_result where uid='$uid' and result_status='Pass' group by quid");
return $query->num_rows();						
...
$uid=$user['uid'];
 $query=$this->db->query("select * from GST_result where uid='$uid' and result_status='Fail' group by quid");
return $query->num_rows();						
